...
class AppLocalizations {
  static const Iterable<String> supportedLanguages = ['en'];
  ...
  String stringFormat(String key, [args]) {
    final string = _localizedStrings[key];

    return string != null && args != null ? sprintf(string, args) : key;
  }
}
